...
export const radhaKrishnaStory = [
  {
    id: "birth",
    title: {
      en: "Birth of Krishna",
    ...
    story: {
      ...
      or: "ମଥୁରାର ଏକ ଝଡ଼ବର୍ଷା ରାତିରେ, ଦେବକୀ ଓ ବାସୁଦେବଙ୍କ କୋଳରେ ଭଗବାନ କୃଷ୍ଣ ଜେଲ ଭିତରେ ଜନ୍ମ ନେଇଥିଲେ। ନିଷ୍ଠୁର ରାଜା କଂସ ଦେବକୀଙ୍କ ଅଷ୍ଟମ ସନ୍ତାନକୁ ମାରିବାକୁ ଶପଥ ନେଇଥିଲେ। କିନ୍ତୁ ଅଲୌକିକ ଭାବେ ଜେଲର କବାଟ ଖୋଲିଗଲା ଓ ସେଥିରେ ଥିବା ସମସ୍ତ ପହରାଦାର ଶୋଇପଡ଼ିଲେ। ବାସୁଦେବ ସେହି ଦିବ୍ୟ ଶିଶୁକୁ ନେଇ ଯମୁନା ନଦୀ ପାର ହୋଇ ଗୋପପୁରରେ ପହଞ୍ଚିଲେ। ସେଠାରେ ନନ୍ଦ ବାବା ଓ ମାତା ଯଶୋଦାଙ୍କ ପାଖରେ କୃଷ୍ଣ ସୁରକ୍ଷିତ ରହିଲେ।"
    },
    fact: {
      en: "Krishna was born at midnight on the eighth day (Ashtami) of the dark fortnight, celebrated globally as Janmashtami.",
      hi: "कृष्ण का जन्म अंधेरे पखवाड़े (कृष्ण पक्ष) के आठवें दिन (अष्टमी) की आधी रात को हुआ था, जिसे दुनिया भर में जन्माष्टमी के रूप में मनाया जाता है।",
      or: "କୃଷ୍ଣ କୃଷ୍ଣପକ୍ଷ ଅଷ୍ଟମୀ ତିଥିର ମଧ୍ୟରାତ୍ରିରେ ଜନ୍ମ ହୋଇଥିଲେ, ଯାହାକୁ ବିଶ୍ୱବ୍ୟାପୀ ଜନ୍ମାଷ୍ଟମୀ ଭାବରେ ପାଳନ କରାଯାଏ।"
    }
  },
  {
    id: "childhood",
    title: {
      en: "Childhood in Gokul",
      hi: "गोकुल में बचपन",
      or: "ଗୋପପୁରରେ ପିଲାଦିନ"
    },
    meet: {
    ...
    story: {
      ...
      or: "ଗୋପପୁରରେ କୃଷ୍ଣଙ୍କ ପିଲାଦିନ ଦିବ୍ୟ ଲୀଳାରେ ଭରପୂର ଥିଲା। ସେ ଜଙ୍ଗଲରେ ଗାଈ ଚରାଇବା ଓ ସାଙ୍ଗମାନଙ୍କ ସହ ଖେଳିବାରେ ସମୟ ବିତାଉଥିଲେ। ପିଲାଦିନରୁ ସେ ଅଦ୍ଭୁତ ଶକ୍ତି ଓ ଜ୍ଞାନ ପ୍ରଦର୍ଶନ କରି ଗ୍ରାମବାସୀଙ୍କ ମନ ଜିଣିଥିଲେ। ତାଙ୍କ ହସ ଓ ଚମତ୍କାର ଖେଳ ଗୋପପୁରରେ ଆନନ୍ଦ ଭରି ଦେଇଥିଲା। ମାତା ଯଶୋଦା ତାଙ୍କୁ ଅତି ସ୍ନେହ କରୁଥିଲେ, ଯିଏ ଥରେ କୃଷ୍ଣଙ୍କ ପାଟିରେ ସମଗ୍ର ବିଶ୍ୱବ୍ରହ୍ମାଣ୍ଡ ଦେଖିଥିଲେ।"
    },
    fact: {
      en: "Even the demons sent by Kansa, like Putana, could not harm him; instead, they attained liberation by his touch.",
      hi: "कंस द्वारा भेजे गए पूतना जैसे राक्षस भी उन्हें नुकसान नहीं पहुँचा सके; इसके बजाय, वे उनके स्पर्श से मुक्ति पा गए।",
      or: "କଂସ ପଠାଇଥିବା ପୂତନା ଭଳି ରାକ୍ଷସୀ ମଧ୍ୟ ତାଙ୍କର କିଛି କ୍ଷତି କରିପାରିନଥିଲେ, ବରଂ ତାଙ୍କୁ ମୁକ୍ତି ମିଳିଥିଲା।"
    }
  },
  {
    id: "butter-thief",
    title: {
      en: "Krishna the Butter Thief",
      hi: "माखन चोर कृष्ण",
      or: "ମାଖନ ଚୋର କୃଷ୍ଣ"
    },
    meet: {
    ...
    story: {
      ...
      or: "କୃଷ୍ଣ ଲହୁଣୀ ଖାଇବାକୁ ବହୁତ ଭଲ ପାଉଥିଲେ। ସେ ସାଙ୍ଗମାନଙ୍କ ସହ ମିଶି ଘରେ ଝୁଲୁଥିବା ଲହୁଣୀ ହାଣ୍ଡିରୁ ଚୋରି କରୁଥିଲେ। ଗୋପୀମାନେ ଧରିଲେ ବି ତାଙ୍କ ନିରୀହ ଚାହାଣୀ ଦେଖି ସବୁ ରାଗ ଭୁଲିଯାଉଥିଲେ। ବେଳେବେଳେ ସେ ମାଙ୍କଡ଼ମାନଙ୍କୁ ବି ଲହୁଣୀ ଖୁଆଉଥିଲେ। ଏଥିପାଇଁ ତାଙ୍କୁ 'ମାଖନ ଚୋର' କୁହାଯାଏ। ଏହା କେବଳ ଚୋରି ନଥିଲା, ଭକ୍ତଙ୍କ ହୃଦୟ ଜିତିବାର ଏକ ଲୀଳା ଥିଲା।"
    },
    fact: {
      en: "Krishna is known as 'Makhan Chor' not because he needed food, but because he loved the affection with which the Gopis churned the butter.",
      hi: "कृष्ण को 'माखन चोर' के रूप में जाना जाता है, इसलिए नहीं कि उन्हें भोजन की आवश्यकता थी, बल्कि इसलिए कि उन्हें उस स्नेह से प्यार था जिसके साथ गोपियां मक्खन मथती थीं।",
      or: "କୃଷ୍ଣଙ୍କୁ 'ମାଖନ ଚୋର' କୁହାଯାଏ କାରଣ ସେ ଗୋପୀମାନଙ୍କ ଶ୍ରଦ୍ଧାରେ ତିଆରି ଲହୁଣୀକୁ ଭଲ ପାଉଥିଲେ।"
    }
  },
  {
    id: "meeting-radha",
    ...
    story: {
      ...
      or: "ବୃନ୍ଦାବନର ପବିତ୍ର ବନରେ କୃଷ୍ଣ, ବୃଷଭାନୁଙ୍କ କନ୍ୟା ରାଧାଙ୍କୁ ଭେଟିଥିଲେ। ଏହି ମିଳନ ସାଧାରଣ ନଥିଲା, ଏହା ଥିଲା ପରମାତ୍ମାଙ୍କ ସହ ତାଙ୍କ ଶକ୍ତିର ମିଳନ। ପ୍ରଥମ ଦେଖାରେ ହିଁ ସେମାନଙ୍କ ମଧ୍ୟରେ ଗଭୀର ସମ୍ପର୍କ ଗଢ଼ି ଉଠିଥିଲା। ସେମାନେ ଏକାଠି ଖେଳୁଥିଲେ ଓ ବ୍ରଜର ବନରେ ବୁଲୁଥିଲେ। ସେମାନଙ୍କ ସମ୍ପର୍କ ନିସ୍ୱାର୍ଥପର ଓ ପବିତ୍ର ପ୍ରେମର ଏକ ଶ୍ରେଷ୍ଠ ଉଦାହରଣ ଥିଲା।"
    },
    fact: {
      en: "Radha is known as 'Raseshwari', the queen of the Raas dance, and 'Hladini Shakti', the pleasure-potency of God.",
      hi: "राधा को 'रासेश्वरी', रास नृत्य की रानी, और 'ह्लादिनी शक्ति', भगवान की आनंद-शक्ति के रूप में जाना जाता है।",
      or: "ରାଧାଙ୍କୁ 'ରାସେଶ୍ୱରୀ' ବା ରାସର ରାଣୀ ଏବଂ ଭଗବାନଙ୍କ 'ହ୍ଲାଦିନୀ ଶକ୍ତି' କୁହାଯାଏ।"
    }
  },
  {
    id: "flute",
    ...
    story: {
      ...
      or: "ଯେତେବେଳେ କୃଷ୍ଣ ବୃନ୍ଦାବନରେ ବଂଶୀ ବଜାଉଥିଲେ, ସମଗ୍ର ସୃଷ୍ଟି ସ୍ତବ୍ଧ ହୋଇଯାଉଥିଲା। ତାଙ୍କ ବଂଶୀ ସ୍ୱରରେ ମୟୂର ନାଚୁଥିଲେ, ନଦୀର ଗତି ଧୀର ହୋଇଯାଉଥିଲା ଏବଂ ଗୋପୀମାନେ ଘରକାମ ଛାଡ଼ି ଦୌଡ଼ି ଆସୁଥିଲେ। ଏହା ଥିଲା ଆତ୍ମାକୁ ପରମାତ୍ମାଙ୍କ ଡାକ। ତାଙ୍କ ବଂଶୀର ପ୍ରତ୍ୟେକ ସ୍ୱର ରାଧାଙ୍କ ହୃଦୟ ପାଇଁ ପ୍ରେମର ବାର୍ତ୍ତା ଥିଲା।"
    },
    fact: {
      en: "Krishna's flute is named 'Murali'. It is hollow, representing a heart empty of ego, ready to be filled with divine breath.",
      hi: "कृष्ण की बांसुरी का नाम 'मुरली' है। यह खोखली है, जो अहंकार से खाली दिल का प्रतिनिधित्व करती है, जो दिव्य सांस से भरने के लिए तैयार है।",
      or: "କୃଷ୍ଣଙ୍କ ବଂଶୀର ନାମ 'ମୁରଲୀ'। ଏହା ଫମ୍ପା, ଯାହା ଅହଂକାର ଶୂନ୍ୟ ହୃଦୟର ପ୍ରତୀକ।"
    }
  },
  {
    id: "raas-leela",
    ...
    story: {
      ...
      or: "ଶରତ ଋତୁର ଏକ ରାତିରେ ଯମୁନା କୂଳରେ କୃଷ୍ଣ 'ମହା ରାସ'ର ଆୟୋଜନ କରିଥିଲେ। ସେ ଅନେକ ରୂପ ଧାରଣ କରି ପ୍ରତ୍ୟେକ ଗୋପୀଙ୍କ ସହ ଏକା ସାଙ୍ଗରେ ନାଚିଥିଲେ। ରାଧା ଏହି ନୃତ୍ୟର କେନ୍ଦ୍ରବିନ୍ଦୁ ଥିଲେ। ଏହା ଥିଲା ଆତ୍ମା ଓ ପରମାତ୍ମାଙ୍କ ମିଳନର ଏକ ଦିବ୍ୟ ନୃତ୍ୟ। ଏହା କେବଳ ନାଚ ନଥିଲା, ବରଂ ଭକ୍ତି ଓ ମୁକ୍ତିର ଏକ ମହାନ ଉତ୍ସବ ଥିଲା।"
    },
    fact: {
      en: "The Raas Leela is described in the Bhagavata Purana as the 'Dance of Divine Love' where one night stretched for the duration of a Kalpa (billions of years).",
      hi: "भागवत पुराण में रास लीला को 'दिव्य प्रेम का नृत्य' बताया गया है जहाँ एक रात एक कल्प (अरबों वर्ष) की अवधि तक खिंच गई थी।",
      or: "ଭାଗବତ ପୁରାଣରେ ରାସ ଲୀଳାକୁ 'ଦିବ୍ୟ ପ୍ରେମର ନୃତ୍ୟ' କୁହାଯାଏ, ଯେଉଁଠି ଗୋଟିଏ ରାତି କୋଟି କୋଟି ବର୍ଷ ପରି ଲମ୍ବା ହୋଇଯାଇଥିଲା।"
    }
  },
  {
    id: "govardhan",
    title: {
      en: "Krishna Lifts Govardhan",
      hi: "गोवर्धन पर्वत उठाना",
      or: "ଗୋବର୍ଦ୍ଧନ ପର୍ବତ ଧାରଣ"
    },
    meet: {
      en: "Indra Dev",
      hi: "इंद्र देव",
    ...
    story: {
      ...
      or: "ଯେତେବେଳେ ବ୍ରଜବାସୀ ଇନ୍ଦ୍ର ପୂଜା ପାଇଁ ପ୍ରସ୍ତୁତ ହେଉଥିଲେ, କୃଷ୍ଣ ସେମାନଙ୍କୁ ଗୋବର୍ଦ୍ଧନ ପର୍ବତ ପୂଜା କରିବାକୁ କହିଥିଲେ। ଏଥିରେ କ୍ରୋଧିତ ହୋଇ ଇନ୍ଦ୍ର ପ୍ରବଳ ବର୍ଷା ଓ ଝଡ଼ ସୃଷ୍ଟି କଲେ। ଗ୍ରାମବାସୀଙ୍କୁ ରକ୍ଷା କରିବାକୁ ୭ ବର୍ଷର କୃଷ୍ଣ ନିଜ ବାମ ହାତର କାଣି ଆଙ୍ଗୁଠିରେ ବିଶାଳ ଗୋବର୍ଦ୍ଧନ ପର୍ବତକୁ ଟେକି ଧରିଥିଲେ। ସାତ ଦିନ ପର୍ଯ୍ୟନ୍ତ ସେ ଏହାକୁ ଛତା ପରି ଧରି ରଖିଥିଲେ, ଶେଷରେ ଇନ୍ଦ୍ର ନିଜ ଭୁଲ ବୁଝିପାରିଥିଲେ।"
    },
    fact: {
      en: "Since then, Krishna is known as 'Giridhari' (The Lifter of the Mountain), and Govardhan Puja acts as a reminder that nature is divine.",
      hi: "तब से, कृष्ण को 'गिरिधारी' (पर्वत को उठाने वाले) के रूप में जाना जाता है, और गोवर्धन पूजा एक अनुस्मारक के रूप में कार्य करती है कि प्रकृति दिव्य है।",
      or: "ସେବେଠାରୁ କୃଷ୍ଣଙ୍କୁ 'ଗିରିଧାରୀ' କୁହାଯାଏ ଏବଂ ଗୋବର୍ଦ୍ଧନ ପୂଜା ପ୍ରକୃତିର ମହତ୍ତ୍ୱ ବୁଝାଏ।"
    }
  },
  {
    id: "kaliya",
    ...
    story: {
      ...
      or: "କାଳୀୟ ନାମକ ଏକ ବିଷାକ୍ତ ସାପ ଯମୁନା ନଦୀର ପାଣିକୁ ବିଷାକ୍ତ କରିଦେଇଥିଲା। କୃଷ୍ଣ ସାଙ୍ଗମାନଙ୍କ ସହ ଖେଳୁଥିବା ବେଳେ ନଦୀକୁ ଡେଇଁପଡ଼ିଲେ। କାଳୀୟ ତାଙ୍କୁ ଆକ୍ରମଣ କଲା, କିନ୍ତୁ କୃଷ୍ଣ ତା'ର ଫଣା ଉପରେ ଚଢ଼ି ନାଚିବାକୁ ଲାଗିଲେ। ଶେଷରେ କାଳୀୟ ପରାସ୍ତ ହେଲା ଓ ନିଜ ପରିବାର ସହ ସମୁଦ୍ରକୁ ଚାଲିଗଲା, ଯାହାଦ୍ୱାରା ଯମୁନା ନଦୀ ପୁଣି ସ୍ୱଚ୍ଛ ହୋଇଗଲା।"
    },
    fact: {
      en: "The footprints of Krishna on Kaliya's head acted as a mark of protection against Garuda, the eagle enemy of snakes.",
      hi: "कालिया के सिर पर कृष्ण के पैरों के निशान ने सांपों के दुश्मन, गरुड़, के खिलाफ सुरक्षा के निशान के रूप में काम किया।",
      or: "କାଳୀୟର ମୁଣ୍ଡରେ କୃଷ୍ଣଙ୍କ ପାଦ ଚିହ୍ନ ତାକୁ ଗରୁଡ଼ କବଳରୁ ରକ୍ଷା କରିବା ପାଇଁ ଏକ କବଚ ସାଜିଥିଲା।"
    }
  },
  {
    id: "radha-love",
    ...
    story: {
      ...
      or: "ରାଧାଙ୍କ ପ୍ରେମ କୌଣସି ବନ୍ଧନ କିମ୍ବା ସମାଜର ନିୟମରେ ବାନ୍ଧି ହୋଇନଥିଲା। ସେ କୃଷ୍ଣଙ୍କୁ ଭଗବାନ ଭାବେ ନୁହେଁ, ବରଂ ନିଜ ସର୍ବସ୍ୱ ଭାବେ ଭଲ ପାଉଥିଲେ। କୃଷ୍ଣ ପାଖରେ ଥିଲେ ସେ ଖୁସି ରହୁଥିଲେ ଆଉ ଦୂରରେ ଥିଲେ ସର୍ବଦା ତାଙ୍କ କଥା ଭାବୁଥିଲେ। ତାଙ୍କ ପ୍ରେମ ତ୍ୟାଗ ଓ ନିସ୍ୱାର୍ଥପର ଭକ୍ତିର ଏକ ଅଦ୍ୱିତୀୟ ଉଦାହରଣ ଥିଲା।"
    },
    fact: {
      en: "It is said that Krishna enchants the world, but Radha enchants even Krishna. That is why she is the supreme goddess.",
      hi: "कहा जाता है कि कृष्ण दुनिया को मोहित करते हैं, लेकिन राधा कृष्ण को भी मोहित करती हैं। यही कारण है कि वह सर्वोच्च देवी हैं।",
      or: "କୁହାଯାଏ ଯେ କୃଷ୍ଣ ସମଗ୍ର ବିଶ୍ୱକୁ ମୋହିତ କରନ୍ତି, କିନ୍ତୁ ରାଧା କୃଷ୍ଣଙ୍କୁ ମଧ୍ୟ ମୋହିତ କରନ୍ତି। ତେଣୁ ସେ ସର୍ବଶ୍ରେଷ୍ଠ ଦେବୀ।"
    }
  },
  {
    id: "farewell",
    title: {
      en: "Farewell from Vrindavan",
      hi: "वृंदावन से विदाई",
      or: "ବୃନ୍ଦାବନରୁ ବିଦାୟ"
    },
    meet: {
    ...
    story: {
      ...
      or: "କୃଷ୍ଣଙ୍କ ପାଇଁ ମଥୁରା ଯାଇ କଂସକୁ ବଧ କରିବାର ସମୟ ଆସିଯାଇଥିଲା। ଅକ୍ରୂର ତାଙ୍କୁ ନେବା ପାଇଁ ରଥ ନେଇ ଆସିଥିଲେ। ଏହି ବିଦାୟ ମୁହୂର୍ତ୍ତ ଅତି ଦୁଃଖଦାୟକ ଥିଲା। ଗୋପୀମାନେ କାନ୍ଦି ରଥ ଆଗରେ ଛିଡ଼ା ହୋଇଗଲେ, କିନ୍ତୁ ରାଧା ନୀରବରେ ଛିଡ଼ା ହୋଇଥିଲେ। କୃଷ୍ଣ ତାଙ୍କର ବଂଶୀ ଓ ମୟୂର ଚନ୍ଦ୍ରିକା ରାଧାଙ୍କ ପାଖରେ ଛାଡ଼ିଦେଲେ, ଯାହା ବୁଝାଉଥିଲା ଯେ ସେ ତାଙ୍କ ଆତ୍ମାକୁ ବୃନ୍ଦାବନରେ ଛାଡ଼ି ଯାଉଛନ୍ତି।"
    },
    fact: {
      en: "Krishna never played the flute again after leaving Vrindavan, signifying that his sweet music belonged only to Radha and the Gopis.",
      hi: "वृंदावन छोड़ने के बाद कृष्ण ने कभी भी बांसुरी नहीं बजाई, जो यह दर्शाता है कि उनका मधुर संगीत केवल राधा और गोपियों का था।",
      or: "ବୃନ୍ଦାବନ ଛାଡ଼ିବା ପରେ କୃଷ୍ଣ ଆଉ କେବେ ବଂଶୀ ବଜାଇ ନଥିଲେ। ତାଙ୍କ ସଙ୍ଗୀତ କେବଳ ରାଧା ଓ ଗୋପୀମାନଙ୍କ ପାଇଁ ଥିଲା।"
    }
  },
  {
    id: "kansa",
    ...
    story: {
      ...
      or: "ମଥୁରାରେ ପହଞ୍ଚି କୃଷ୍ଣ ଓ ବଳରାମ ମଲ୍ଲଯୁଦ୍ଧରେ ଚାଣୂର ଓ ମୁଷ୍ଟିକ ଭଳି ଶକ୍ତିଶାଳୀ ପହଲବାନଙ୍କୁ ପରାସ୍ତ କଲେ। ଶେଷରେ କୃଷ୍ଣ ଅତ୍ୟାଚାରୀ ମାମୁଁ କଂସର ସାମ୍ନା କଲେ। ସେ କଂସକୁ ସିଂହାସନରୁ ଟାଣି ଆଣି ବଧ କଲେ। ଏହା ସହ ସେ ନିଜ ପିତାମାତା ଦେବକୀ ଓ ବାସୁଦେବଙ୍କୁ ମୁକ୍ତ କଲେ ଏବଂ ଅଜା ଉଗ୍ରସେନଙ୍କୁ ପୁଣି ରାଜା କଲେ। ଏହିପରି ମଥୁରାରେ ପୁଣି ଧର୍ମ ପ୍ରତିଷ୍ଠା ହେଲା।"
    },
    fact: {
      en: "Kansa attained liberation (moksha) because he thought of Krishna constantly, even if it was out of fear (Vaira-Bhakti).",
      hi: "कंस को मोक्ष की प्राप्ति हुई क्योंकि वह लगातार कृष्ण का स्मरण करता था, भले ही वह डर (वैर-भक्ति) के कारण हो।",
      or: "କଂସ ଭୟରେ ହେଉ ପଛେ ସର୍ବଦା କୃଷ୍ଣଙ୍କୁ ମନେ ପକାଉଥିବାରୁ ତାକୁ ଶେଷରେ ମୋକ୍ଷ ମିଳିଥିଲା।"
    }
  },
  {
    id: "king",
    ...
    meet: {
      en: "Rukmini & Satyabhama",
      hi: "रुक्मिणी और सत्यभामा",
      or: "ରୁକ୍ମିଣୀ ଓ ସତ୍ୟଭାମା"
    },
    place: {
      en: "Dwarka City",
      hi: "द्वारका नगरी",
    ...
    story: {
      ...
      or: "ଜରାସନ୍ଧର ଆକ୍ରମଣରୁ ପ୍ରଜାଙ୍କୁ ରକ୍ଷା କରିବା ପାଇଁ, କୃଷ୍ଣ ମଥୁରା ଛାଡ଼ି ସମୁଦ୍ର ମଧ୍ୟରେ ଦ୍ୱାରକା ନଗରୀ ନିର୍ମାଣ କଲେ। 'ଦ୍ୱାରକାଧୀଶ' ରୂପେ ସେ ସେଠାରେ ରାଜୁତି କଲେ। ଦ୍ୱାରକା ଏକ ସ୍ୱର୍ଣ୍ଣ ନଗରୀ ଥିଲା। ସେଠାରେ କୃଷ୍ଣ ରୁକ୍ମିଣୀ ଓ ସତ୍ୟଭାମାଙ୍କ ସହ ବିବାହ କରି ରାଜକୀୟ ଜୀବନ ବିତାଇଥିଲେ, ତଥାପି ସେ ସର୍ବଦା ଜ୍ଞାନୀ ଓ ନିର୍ଲିପ୍ତ ଥିଲେ।"
    },
    fact: {
      en: "Dwarka is believed to have submerged under the ocean after Krishna left the earth, and underwater ruins have been found by archaeologists.",
      hi: "माना जाता है कि कृष्ण के पृथ्वी छोड़ने के बाद द्वारका समुद्र में डूब गई थी, और पुरातत्वविदों द्वारा पानी के नीचे के खंडहर पाए गए हैं।",
      or: "କୃଷ୍ଣଙ୍କ ଦେହତ୍ୟାଗ ପରେ ଦ୍ୱାରକା ସମୁଦ୍ରରେ ବୁଡ଼ି ଯାଇଥିଲା ବୋଲି ବିଶ୍ୱାସ କରାଯାଏ, ଯାହାର ପ୍ରମାଣ ସମୁଦ୍ର ଭିତରେ ମିଳିଛି।"
    }
  },
  {
    id: "radha-devotion",
    ...
    story: {
      ...
      or: "ବୃନ୍ଦାବନରେ ରାଧା କୃଷ୍ଣଙ୍କ ସ୍ମୃତିରେ ବଞ୍ଚିଥିଲେ। ସେ ଦୁଃଖରେ ଭାଙ୍ଗି ନପଡ଼ି ନିଜ ଯନ୍ତ୍ରଣାକୁ ଶକ୍ତିରେ ପରିଣତ କରିଥିଲେ। ସେ ଅନୁଭବ କଲେ ଯେ କୃଷ୍ଣ କେବଳ ଜଣେ ବ୍ୟକ୍ତି ନୁହନ୍ତି, ସେ ତାଙ୍କ ହୃଦୟରେ ଅଛନ୍ତି। ତାଙ୍କର ପ୍ରତ୍ୟେକ ମୁହୂର୍ତ୍ତ କୃଷ୍ଣଙ୍କ ଧ୍ୟାନରେ ବିତୁଥିଲା। ତାଙ୍କ ପ୍ରେମ ଏତେ ଗଭୀର ଥିଲା ଯେ ଦ୍ୱାରକାରେ ଥାଇ ମଧ୍ୟ କୃଷ୍ଣ ତାହା ଅନୁଭବ କରିପାରୁଥିଲେ।"
    },
    fact: {
      en: "Though they never married geographically, Radha and Krishna are eternally married in the spiritual realm of Goloka.",
      hi: "यद्यपि उन्होंने भौगोलिक रूप से कभी विवाह नहीं किया, लेकिन राधा और कृष्ण गोलोक के आध्यात्मिक क्षेत्र में अनंत काल तक विवाहित हैं।",
      or: "ଯଦିଓ ସେମାନେ ଏହି ମର୍ତ୍ତ୍ୟଲୋକରେ ବିବାହ କରିନଥିଲେ, ତଥାପି ଆଧ୍ୟାତ୍ମିକ ଜଗତରେ ସେମାନେ ସର୍ବଦା ଏକାଠି।"
    }
  },
  {
    id: "sudama",
    title: {
      en: "Krishna and Sudama",
      hi: "कृष्ण और सुदामा",
      or: "କୃଷ୍ଣ ଓ ସୁଦାମା"
    },
    meet: {
    ...
    story: {
      ...
      or: "କୃଷ୍ଣଙ୍କ ଗରିବ ବାଲ୍ୟବନ୍ଧୁ ସୁଦାମା ସାହାଯ୍ୟ ପାଇଁ ଦ୍ୱାରକା ଆସିଥିଲେ। ସେ ସାଙ୍ଗରେ ମୁଠାଏ ଚୁଡ଼ା ଆଣିଥିଲେ। ରାଜା ହୋଇ ମଧ୍ୟ କୃଷ୍ଣ ସାଙ୍ଗକୁ ଦେଖି ଖାଲି ପାଦରେ ଦୌଡ଼ି ଆସିଲେ। ସେ ନିଜେ ସୁଦାମାଙ୍କ ପାଦ ଧୋଇଲେ ଓ ଆନନ୍ଦରେ ସେହି ଚୁଡ଼ା ଖାଇଲେ। ସେ ସୁଦାମାଙ୍କୁ କିଛି ନକହି ତାଙ୍କ ଘରକୁ ରାଜପ୍ରାସାଦରେ ପରିଣତ କରିଦେଲେ। ଏହା ଥିଲା ପ୍ରକୃତ ବନ୍ଧୁତାର ନିଦର୍ଶନ।"
    },
    fact: {
      en: "Krishna ate two handfuls of rice, giving Sudama two worlds of wealth; Rukmini stopped him from the third to save their own abode!",
      hi: "कृष्ण ने दो मुट्ठी चावल खाए, सुदामा को दो लोकों की संपत्ति दी; रुक्मिणी ने उन्हें अपने निवास को बचाने के लिए तीसरे से रोक दिया!",
      or: "କୃଷ୍ଣ ଦୁଇ ମୁଠା ଚୁଡ଼ା ଖାଇ ସୁଦାମାଙ୍କୁ ଅମାପ ଧନ ଦେଇଥିଲେ। ତୃତୀୟ ମୁଠା ଖାଇବା ବେଳେ ରୁକ୍ମିଣୀ ତାଙ୍କୁ ଅଟକାଇ ଦେଇଥିଲେ।"
    }
  },
  {
    id: "guide",
    title: {
      en: "Krishna as a Guide (Gita)",
      hi: "गीता का उपदेश",
      or: "ଗୀତା ଉପଦେଶ"
    },
    meet: {
    ...
    story: {
      ...
      or: "ମହାଭାରତ ଯୁଦ୍ଧରେ କୃଷ୍ଣ ଅସ୍ତ୍ର ନ ଉଠାଇ ଅର୍ଜୁନଙ୍କ ସାରଥୀ ହୋଇଥିଲେ। ଯେତେବେଳେ ଅର୍ଜୁନ ଯୁଦ୍ଧ କରିବାକୁ ମନା କଲେ, କୃଷ୍ଣ ତାଙ୍କୁ 'ଭଗବଦ୍ ଗୀତା' ଶୁଣାଇଥିଲେ। ସେ ଜୀବନ, କର୍ମ, ଆତ୍ମା ଓ ଭକ୍ତିର ଗୂଢ଼ ରହସ୍ୟ ବୁଝାଇଥିଲେ। ସେ ଅର୍ଜୁନଙ୍କୁ ନିଜର ବିଶ୍ୱରୂପ ଦେଖାଇଥିଲେ। କୃଷ୍ଣଙ୍କ ମାର୍ଗଦର୍ଶନରେ ପାଣ୍ଡବମାନେ ଯୁଦ୍ଧରେ ବିଜୟୀ ହେଲେ।"
    },
    fact: {
      en: "The Bhagavad Gita is considered the manual of life, answering every human dilemma through 700 verses.",
      hi: "भगवद गीता को जीवन की पुस्तिका माना जाता है, जो 700 श्लोकों के माध्यम से हर मानवीय दुविधा का उत्तर देती है।",
      or: "ଭଗବଦ୍ ଗୀତାକୁ ଜୀବନର ସାର କୁହାଯାଏ, ଯେଉଁଥିରେ ସମସ୍ତ ସମସ୍ୟାର ସମାଧାନ ରହିଛି।"
    }
  },
  {
    id: "spiritual-love",
    title: {
      en: "Radha Krishna’s Spiritual Love",
      hi: "राधा कृष्ण का आध्यात्मिक प्रेम",
      or: "ରାଧା କୃଷ୍ଣଙ୍କ ଆଧ୍ୟାତ୍ମିକ ପ୍ରେମ"
    },
    meet: {
      en: "One Soul",
      hi: "एक आत्मा",
    ...
    story: {
      ...
      or: "ରାଧା କୃଷ୍ଣଙ୍କ ପ୍ରେମ କାହାଣୀ ସାଧାରଣ ନୁହେଁ, ଏହା ପରମାତ୍ମା ଓ ଜୀବାତ୍ମାର ମିଳନ। ରାଧା ହେଉଛନ୍ତି କୃଷ୍ଣଙ୍କ ପ୍ରେମର ପ୍ରତୀକ। ସେମାନେ ଗୋଟିଏ ଆତ୍ମା, କିନ୍ତୁ ପ୍ରେମର ଆସ୍ୱାଦନ ପାଇଁ ଦୁଇଟି ଶରୀର ଧାରଣ କରିଛନ୍ତି। ତାଙ୍କ ପ୍ରେମ ଶିଖାଏ ଯେ ପ୍ରକୃତ ପ୍ରେମ ପାଇବାରେ ନୁହେଁ, ସମର୍ପଣରେ ଥାଏ। ତେଣୁ ମନ୍ଦିରରେ କୃଷ୍ଣଙ୍କ ପୂର୍ବରୁ ରାଧାଙ୍କୁ ପୂଜା କରାଯାଏ।"
    },
    fact: {
      en: "Their names are never uttered separately; it is always 'Radha-Krishna', symbolizing their inseparable eternal union.",
      hi: "उनके नाम कभी अलग-अलग नहीं बोले जाते; यह हमेशा 'राधा-कृष्ण' होता है, जो उनके अविभाज्य शाश्वत मिलन का प्रतीक है।",
      or: "ସେମାନଙ୍କ ନାମ କେବେବି ଅଲଗା ନିଆଯାଏ ନାହିଁ; ସର୍ବଦା 'ରାଧା-କୃଷ୍ଣ' କୁହାଯାଏ, ଯାହା ତାଙ୍କ ଅତୁଟ ସମ୍ପର୍କର ପ୍ରତୀକ।"
    }
  },
  {
    id: "protector",
    title: {
      en: "Krishna the Protector",
      hi: "रक्षक कृष्ण",
      or: "ରକ୍ଷକ କୃଷ୍ଣ"
    },
    meet: {
    ...
    story: {
      ...
      or: "କୃଷ୍ଣ ସର୍ବଦା ଧର୍ମର ରକ୍ଷକ ଥିଲେ। ସେ କୌରବ ସଭାରେ ଦ୍ରୌପଦୀଙ୍କ ଲଜ୍ଜା ନିବାରଣ କରିଥିଲେ। ପାଣ୍ଡବମାନଙ୍କୁ ସେ ଅନେକ ବିପଦରୁ ରକ୍ଷା କରିଥିଲେ। ନରକାସୁର ବନ୍ଦୀ କରି ରଖିଥିବା ୧୬,୧୦୦ ନାରୀଙ୍କୁ ମୁକ୍ତ କରି ସେମାନଙ୍କୁ ସମ୍ମାନ ଦେଇଥିଲେ। ଯିଏ ତାଙ୍କ ଶରଣ ପଶିଛି, ସିଏ ପାପୀ ହେଉ ବା ସନ୍ଥ, କୃଷ୍ଣ ସମସ୍ତଙ୍କୁ ରକ୍ଷା କରିଛନ୍ତି।"
    },
    fact: {
      en: "His promise in the Gita 'Maamekam Sharanam Vraja' (Surrender to Me alone, I shall deliver you from all sins) is the ultimate assurance to humanity.",
      hi: "गीता में उनका वादा 'मामेकम शरणम व्रज' (अकेले मेरी शरण में आओ, मैं तुम्हें सभी पापों से मुक्त कर दूंगा) मानवता के लिए अंतिम आश्वासन है।",
      or: "ଗୀତାରେ ତାଙ୍କର ବଚନ - 'ମୋ ଶରଣରେ ଆସ, ମୁଁ ତୁମକୁ ସମସ୍ତ ପାପରୁ ମୁକ୍ତ କରିବି' - ମାନବ ଜାତି ପାଇଁ ସବୁଠାରୁ ବଡ଼ ଆଶ୍ୱାସନା।"
    }
  },
  {
    id: "eternal-bond",
    title: {
      en: "The Eternal Bond in Goloka",
      hi: "गोलोक में अटूट बंधन",
      or: "ଗୋଲୋକରେ ଅତୁଟ ବନ୍ଧନ"
    },
    meet: {
      en: "Divine Couple",
      hi: "दिव्य युगल",
    ...
    story: {
      ...
      or: "ଏହି ସଂସାର ବାହାରେ ଗୋଲୋକ ବୃନ୍ଦାବନ ନାମକ ଏକ ଦିବ୍ୟ ଧାମ ଅଛି, ଯେଉଁଠାରେ ରାଧା କୃଷ୍ଣ ସର୍ବଦା ବାସ କରନ୍ତି। ସେଠାରେ ଦୁଃଖ ନାହିଁ କି ବିଚ୍ଛେଦ ନାହିଁ। ସେଠାରେ ସେମାନେ ସର୍ବଦା ଲୀଳା କରନ୍ତି। ଭକ୍ତମାନେ ମୁକ୍ତି ଚାହାନ୍ତି ନାହିଁ, ବରଂ ସେହି ଧାମରେ ପହଞ୍ଚି ରାଧା କୃଷ୍ଣଙ୍କ ସେବା କରିବାକୁ ଚାହାନ୍ତି।"
    },
    fact: {
      en: "Goloka is described as shaped like a thousand-petaled lotus, with Radha and Krishna seated in the center.",
      hi: "गोलोक को हजार पंखुड़ियों वाले कमल के आकार का बताया गया है, जिसके केंद्र में राधा और कृष्ण विराजमान हैं।",
      or: "ଗୋଲୋକ ଧାମକୁ ଏକ ହଜାର ପାଖୁଡ଼ା ଥିବା ପଦ୍ମ ସହ ତୁଳନା କରାଯାଏ, ଯାହାର ମଝିରେ ରାଧା କୃଷ୍ଣ ରହିଥାନ୍ତି।"
    }
  },
  {
    id: "symbol",
    title: {
      en: "Symbol of Divine Union",
      hi: "दिव्य मिलन का प्रतीक",
      or: "ଦିବ୍ୟ ମିଳନର ପ୍ରତୀକ"
    },
    meet: {
      en: "Purusha & Prakriti",
      hi: "पुरुष और प्रकृति",
    ...
    story: {
      ...
      or: "ରାଧା ଓ କୃଷ୍ଣ ସଂସାରର ପୁରୁଷ ଓ ପ୍ରକୃତିର ସନ୍ତୁଳନକୁ ବୁଝାନ୍ତି। କୃଷ୍ଣ ହେଉଛନ୍ତି ଶକ୍ତିମାନ ଓ ରାଧା ହେଉଛନ୍ତି ଶକ୍ତି। ଅଗ୍ନି ଓ ତାପ ପରି ସେମାନେ ପରସ୍ପରଠାରୁ ଅଭିନ୍ନ। ସେମାନଙ୍କ ଏକତ୍ର ପୂଜା ଜୀବନରେ ଶାନ୍ତି, ପ୍ରେମ ଓ ସନ୍ତୁଳନ ଆଣିଥାଏ।"
    },
    fact: {
      en: "The word 'Radha' acts as a 'Dhara' (flow) of devotion towards the feet of Krishna.",
      hi: "'राधा' शब्द कृष्ण के चरणों के प्रति भक्ति की 'धारा' (प्रवाह) के रूप में कार्य करता है।",
      or: "'ରାଧା' ଶବ୍ଦର ଓଲଟା ହେଉଛି 'ଧାରା', ଯାହା କୃଷ୍ଣଙ୍କ ପ୍ରତି ଭକ୍ତିର ସ୍ରୋତକୁ ବୁଝାଏ।"
    }
  },
  {
    id: "legacy",
    title: {
      en: "Legacy of Divine Love",
      hi: "दिव्य प्रेम की विरासत",
      or: "ଦିବ୍ୟ ପ୍ରେମର ପରମ୍ପରା"
    },
    meet: {
    ...
    story: {
      ...
      or: "ରାଧା କୃଷ୍ଣଙ୍କ ପ୍ରେମ କାହାଣୀ କଳା, ସଙ୍ଗୀତ ଓ ନୃତ୍ୟ ମାଧ୍ୟମରେ ଆଜି ବି ଜୀବନ୍ତ। ହୋଲି, ଜନ୍ମାଷ୍ଟମୀ ଓ ରାଧାଷ୍ଟମୀ ଭଳି ପର୍ବରେ ଆମେ ତାଙ୍କୁ ମନେ ପକାଉ। ଚୈତନ୍ୟ ମହାପ୍ରଭୁ 'ହରେ କୃଷ୍ଣ' ମନ୍ତ୍ର ଦ୍ୱାରା ଏହି ପ୍ରେମର ପ୍ରଚାର କରିଥିଲେ। ସେମାନଙ୍କ କାହାଣୀ ଶିଖାଏ ଯେ ଭଗବାନ କେବଳ ବିଚାରପତି ନୁହନ୍ତି, ସେ ଆମର ପ୍ରିୟ ସାଙ୍ଗ ଓ ପରିଜନ।"
    },
    fact: {
      en: "The Hare Krishna Maha Mantra is composed almost entirely of the names of the divine couple: 'Hare' addresses Radha, and 'Krishna' and 'Rama' address the Lord.",
      hi: "हरे कृष्ण महा मंत्र लगभग पूरी तरह से दिव्य युगल के नामों से बना है: 'हरे' राधा को संबोधित करता है, और 'कृष्ण' और 'राम' भगवान को संबोधित करते हैं।",
      or: "'ହରେ କୃଷ୍ଣ' ମହାମନ୍ତ୍ରରେ 'ହରେ' ଶବ୍ଦ ରାଧାଙ୍କୁ ଓ 'କୃଷ୍ଣ' ଶବ୍ଦ ଭଗବାନଙ୍କୁ ବୁଝାଏ।"
    }
  }
];
